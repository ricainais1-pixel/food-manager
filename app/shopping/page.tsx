  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex flex-wrap justify-center mt-4 gap-4 sm:gap-6 md:gap-8">
        ...
        <Link href="./shopping/stock-from-shopping" className="w-full sm:w-32 md:w-36 max-w-xs">
          <Button className="bg-blue-200 px-6 py-3 w-full sm:w-32 md:w-36 hover:bg-blue-400 max-w-xs">
            在庫へ追加
          </Button>
        </Link>
      </div>
