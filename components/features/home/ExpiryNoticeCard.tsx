...
export default function ExpiryNoticeCard({ expiredFoods, soonFoods }: Props) {
  return (
    <section className="m-10 relative w-full max-w-6xl mx-auto">
      <div className="absolute left-6 -top-4 bg-red-300 px-5 py-1 rounded-md shadow font-bold z-10">
        <h2 className="text-2xl font-bold">お知らせ</h2>
      </div>
      <div className="flex flex-col md:flex-row gap-6 border-2 rounded-xl p-6 pt-10 bg-white max-h-[300px] overflow-y-auto">
